      ...
      <div className="max-w-[1600px] mx-auto h-full px-6 flex items-center justify-between gap-8">
        ...
        <div className="flex items-center gap-10">
          ...
          <nav className="hidden md:flex items-center gap-7">
            <Link to="/" className="text-[15px] font-semibold text-slate-900 relative after:absolute after:bottom-[-20px] after:left-1/2 after:-translate-x-1/2 after:w-4 after:h-[3px] after:bg-slate-900 after:rounded-t-full transition-colors">
              首页
            </Link>
            <Link to="#" className="text-[15px] font-medium text-slate-500 hover:text-slate-900 transition-colors">
              分类
            </Link>
          </nav>
        </div>
        ...
        <div className="flex items-center gap-5">
          ...
          <button
            type="button"
            onClick={onStartLive}
            className="hidden lg:flex items-center gap-2 px-5 py-2.5 bg-slate-900 hover:bg-slate-800 text-white text-[14px] font-medium rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-slate-300/50 hover:-translate-y-0.5"
          >
